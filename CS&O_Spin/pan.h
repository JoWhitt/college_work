...
#define PanSource	"dining_philosophers.pml"
...
#define PtwoSittingApart	((P2 *)this)
...
#define HAS_TRACK	0
/* hidden variable: */	int phils_eating_now[5];
/* hidden variable: */	int phils_eating;
